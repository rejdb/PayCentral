...
module.exports = "<section class=\"container\">\n  <div class=\"row justify-content-center\">\n    <div  class=\"col-lg-6 col-md-10 col-sm-12 col-xs-12\">\n      <div class=\"text-center mb-4\"><h4>How would you like to Cash-In?</h4></div>\n      <div class=\"row justify-content-center\">\n        <div class=\"col-lg-4 col-md-4 col-sm-6 col-xs-6 payout_feature\" *ngFor=\"let feature of payout_features\">\n          <div class=\"card text-center payout_feature_item\" (click)=\"nextsteps(feature)\">\n            <img class=\"card-img-top\" src=\"{{feature.logo_url}}\" alt=\"Card image cap\">\n            <div class=\"card-block\">\n              <h4 class=\"card-title\">{{feature.name}}</h4>\n              <p class=\"card-text\"></p>\n            </div>\n            <div class=\"card-footer\"><strong>{{feature.payment_outlet_type.payout_duration || 'Instant'}}</strong> after payment</div>\n          </div>\n        </div>\n      </div>\n      <div class=\"text-center mb-4\"><h4>You can also try these other options</h4></div>\n      <div class=\"row justify-content-center\" id=\"accordion\">\n        <div class=\"col-sm-12 payout-group mb-2\" *ngFor=\"let payout of payouts\">\n          <div class=\"card p-3 payout-group-item\">\n            <div class=\"row card-block\" data-toggle=\"collapse\" [attr.data-target]=\"'#' + payout.id\" aria-expanded=\"true\" [attr.aria-controls]=\"payout.id\">\n              <div class=\"col-md-8 col-sm-12 payout-group-item-left\">\n                <img src=\"\" alt=\"\">\n                <span class=\"pg-item-left-content\">\n                  <div class=\"content-name\">{{payout.name}}</div>\n                  <div class=\"content-desc\"><small>{{payout.outlet_names_subset[0]}}</small></div>\n                </span>\n              </div>\n              <div class=\"col-md-4 col-sm-12 payout-group-item-right text-right\"><span><strong>{{payout.payout_duration || 'Instant'}}</strong> after payment</span></div>\n            </div>\n            <div id=\"{{payout.id}}\" class=\"collapse\" aria-labelledby=\"headingOne\" data-parent=\"#accordion\">\n              <div class=\"card-body\">\n                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</section>\n"
...
// module
exports.push([module.i, ".container {\n  margin-top: 20px;\n  padding: 10px; }\n  .container .payout_feature {\n    margin-bottom: 15px; }\n  .container .payout_feature .payout_feature_item {\n      padding: 10px;\n      height: 120px;\n      background-color: white; }\n  .container .payout_feature .payout_feature_item img.card-img-top {\n        padding: 0 10px;\n        height: 35%;\n        margin-bottom: 10px; }\n  .container .payout_feature .payout_feature_item h4.card-title {\n        font-size: 0.75rem;\n        color: #a19f9f; }\n  .container .payout_feature .payout_feature_item .card-footer {\n        color: #989898;\n        padding: 5px 0;\n        font-size: 8px;\n        display: block;\n        border: 0px !important;\n        position: relative;\n        top: 0px;\n        background-color: transparent; }\n  .container .payout_feature .payout_feature_item .card-footer strong {\n          color: #5760df; }\n  .container .payout_feature .payout_feature_item:hover {\n      border: 1px solid #7373b9;\n      cursor: pointer; }\n  .container .payout-group .payout-group-item {\n    min-height: 70px;\n    background-color: white;\n    padding: 10px; }\n  .container .payout-group .payout-group-item-left {\n    padding-left: 8px;\n    text-align: left;\n    display: inherit;\n    position: relative; }\n  .container .payout-group .payout-group-item-left img {\n      width: 20%;\n      padding: 5px;\n      margin-right: 20px;\n      margin-left: 10px; }\n  .container .payout-group .payout-group-item-left .content-name {\n      font-size: 16px;\n      color: #989898; }\n  .container .payout-group .payout-group-item-left .content-desc {\n      font-size: 14px;\n      color: #b8b3b3;\n      margin-top: -5px; }\n  .container .payout-group .payout-group-item-right {\n    font-size: 0.6rem;\n    color: #b8b3b3; }\n  .container .payout-group .payout-group-item-right strong {\n      color: #5760df; }\n  .container .payout-group-item:hover, .container .payout-group-item:focus {\n    border-color: #75be7c;\n    background-color: #eee;\n    cursor: pointer; }\n", ""]);
...
var CashinComponent = /** @class */ (function () {
    function CashinComponent(_authService, _router) {
        this._authService = _authService;
        this._router = _router;
    }
    CashinComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._authService._get('/api/coins/cashin-featured').subscribe(function (featured) {
            console.log(featured);
            _this.payout_features = featured.payouts;
            _this._authService._get('/api/coins/cashin').subscribe(function (payout) {
                console.log(payout);
                _this.payouts = payout.payouts;
            });
        });
    };
    CashinComponent.prototype.payoutByCategory = function (catid) {
        var _this = this;
        this._authService._get('/api/coins/cashin/' + catid).subscribe(function (data) {
            _this.payout_by_category = data.user;
        });
    };
    CashinComponent.prototype.nextsteps = function (feature) {
        console.log(feature);
    };
...
// module
exports.push([module.i, "section .container {\n  padding: 20px;\n  min-height: 350px; }\n  section .container .bills-item {\n    cursor: pointer; }\n  section .container .bills-item:hover, section .container .bills-item:focus {\n    border-color: #75be7c;\n    cursor: pointer; }\n", ""]);
...
var PaybillsComponent = /** @class */ (function () {
    ...
    PaybillsComponent.prototype.get_selected_payout = function () {
